...
const TableNameDcimPowerport = "dcim_powerport"

// DcimPowerport mapped from table <dcim_powerport>
...
// TableName DcimPowerport's table name
func (*DcimPowerport) TableName() string {
	return TableNameDcimPowerport
}

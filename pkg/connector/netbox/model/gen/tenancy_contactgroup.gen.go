...
const TableNameTenancyContactgroup = "tenancy_contactgroup"

// TenancyContactgroup mapped from table <tenancy_contactgroup>
...
// TableName TenancyContactgroup's table name
func (*TenancyContactgroup) TableName() string {
	return TableNameTenancyContactgroup
}
